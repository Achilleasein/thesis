...
## Abstract
Η παρούσα διπλωματική εργασία επικεντρώνεται στην ανίχνευση ρυθμού (beat detection) και 
στην εκτίμηση του ρυθμικού τέμπο (tempo) σε μουσικά κομμάτια, με πειράματα κυρίως σε τραγούδια με απλό μέτρο 4/4. 
Σκοπός της εργασίας είναι η μελέτη και η υλοποίηση αλγορίθμων ανάλυσης σήματος που επιτρέπουν τον αυτόματο 
εντοπισμό των σημείων ρυθμικής έμφασης (beats) σε ψηφιακά ηχητικά δεδομένα. Η προσέγγιση βασίζεται στη μεθοδολογία των Scheirer και Tzanetakis 
και υλοποιείται ως μια διαδοχική αλυσίδα επεξεργασίας: αρχικά το σήμα αποσυντίθεται σε ζώνες συχνοτήτων μέσω συστοιχίας ζωνοπερατών φίλτρων Butterworth (filterbank)· 
σε κάθε ζώνη εξάγεται ο φάκελος (envelope) με ανόρθωση πλήρους κύματος και εξομάλυνση μέσω παραθύρου Hanning· 
ακολουθεί χρονική διαφόριση και ανόρθωση ημίσεος κύματος για την ανάδειξη των ρυθμικών συμβάντων· 
τέλος, εφαρμόζεται συστοιχία φίλτρων-χτένας (comb filters) συντονισμού, της οποίας η ενεργειακή απόκριση αθροίζεται κατά μήκος των ζωνών για την εξαγωγή του 
θεμελιώδους τέμπο. 
Η υλοποίηση πραγματοποιείται σε περιβάλλον Python, με αναφορά σε αντίστοιχο κώδικα MATLAB, και αξιολογείται σε ενδεικτικά δείγματα δημοφιλούς (Pop) μουσικής. 
Τα αποτελέσματα δείχνουν ότι η προτεινόμενη μεθοδολογία μπορεί να εντοπίσει με ικανοποιητική ακρίβεια τους ρυθμικούς παλμούς, 
παρέχοντας μια αξιόπιστη βάση για μελλοντικές εφαρμογές σε ανάλυση μουσικού περιεχομένου.

## Μουσική Θεωρία

Πριν από οποιαδήποτε μαθηματική προσέγγιση είναι αναγκαία η κατανόηση της μουσικής θεωρίας καθώς και τι προσπαθούμε να πετύχουμε. 
